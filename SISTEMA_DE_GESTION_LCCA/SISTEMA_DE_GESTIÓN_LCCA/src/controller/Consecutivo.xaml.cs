...
{
    /// <summary>
    /// Lógica de interacción para Consecutivo.xaml
    /// </summary>
    public partial class Consecutivo : Window
    {
        ...
        private void btnuploanddata_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                command_buscar.Parameters.AddWithValue("@id", 1);
                ...
                if (reader_buscar.Read())
                {
                    ...
                    string query1 = "UPDATE consecutivo SET Consecutivo = '" + y + "' Where id = '1'";
                    SqlCommand command_update1 = new SqlCommand(query1, connection);
                    command_update1.ExecuteNonQuery();

                    lbconsecutivo_Copy.Content = "GVCM-" + y;
                    ...
                    sqlCommand.Parameters.AddWithValue("@consecutivo", "GVCM-" + y);
