...
namespace SISTEMA_DE_GESTIÓN_LCCA.LOGISTICA
{
    ...
    public partial class Window1 : Window
    {
        ...
        private void cbx1_SelectionChanged_1(object sender, SelectionChangedEventArgs e)
        {
        ...
        private void rdtrasavilidad_Checked(object sender, RoutedEventArgs e)
        {

        }

        private void rdmochila_Checked(object sender, RoutedEventArgs e)
        {
        ...
        //    }
        //}
        //public void loandtomadas()
        //{

        //    connection.Close();
        //    connection.Open();
        //    SqlCommand command2 = new SqlCommand("Select DISTINCT OT from tbregistroconsumosterreno where ESTADO_REGISTRO = '" + filtro + "'  AND TOMADO_POR = '" + ClaseCompartida.nombre + "'", connection);
        ...
        //    connection.Close();
        //    connection.Open();
        //    SqlCommand command2 = new SqlCommand("Select DISTINCT NOMBRE, TOMADO_POR from tbregistroconsumosterreno where ESTADO_REGISTRO = '" + filtro + "'", connection);
        //    SqlDataAdapter adapter2 = new SqlDataAdapter();
        //    adapter2.SelectCommand = command2;
        //    DataTable dataTable2 = new DataTable();
        //    adapter2.Fill(dataTable2);
        ...
        //        {
        //            if (Convert.ToString(row["ESTADO_REGISTRO"]) != "CONSUMO CONFIRMADO")
        //            {
        ...
        //                                    string query2 = "UPDATE tbbodega_consolidado SET CANTIDAD = '" + nueva_can_consoli + "' WHERE ITEM ='" + Convert.ToString(row["ITEM"]) + "'";
        //                                    SqlCommand command_update2 = new SqlCommand(query2, connection);
        //                                    command_update2.Parameters.AddWithValue("ITEM", nueva_can_consoli);
        //                                    command_update2.ExecuteNonQuery();


        //                                    Resta cantidad en bodega tecnico
        //                                    string queryup = "UPDATE tabla" + cedula + " SET CANTIDAD = '" + nueva_can_tecni + "' WHERE ITEM ='" + Convert.ToString(row["ITEM"]) + "'";
        ...
        //        string cadena = "UPDATE tbregistroconsumosterreno SET TOMADO_POR = '' WHERE OT = '" + ot + "'";
        //        SqlCommand comando = new SqlCommand(cadena, connection);
        //        comando.Parameters.AddWithValue("OT", "");
        //        comando.ExecuteNonQuery();
        //        lsnametec();
        //    }
        //    else
